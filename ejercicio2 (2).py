...
Original file is located at
    https://colab.research.google.com/drive/1RzkcRo63zwnqpu5kht_mAZnoY844uxCW
"""
...
def g(x):
    return (np.log(4*x))  # Expresión reorganizada para facilitar el análisis gráfico

# Se calcula la derivada de g(x) para evaluar la convergencia
def g_prime(x):
    return (1/x)  # Derivada obtenida de la función g(x)

# 1.- Cálculo del error absoluto entre iteraciones
def error_absoluto(x_new, x_old):
    return abs(x_new - x_old)

# 2.- Cálculo del error relativo basado en el nuevo valor
def error_relativo(x_new, x_old):
    return abs((x_new - x_old) / x_new)

# 3.- Cálculo del error cuadrático entre iteraciones
...
x0 = 1.0  # Se establece el punto inicial en 1.0
